...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			svg = svg_element("svg");
    			add_location(svg, file, 57, 0, 1829);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function initializeChart(us) {
    		...
    		const colorScale = linear().domain([52000, 102000]).range(["lightgreen", "darkgreen"]); //d3.extent(Array.from(incomeData.values()))
    		// Updated color scale from light green to dark green

    		console.log(incomeData.values());
    		console.log(min$2(incomeData.values()));
